...
export const TodayScreen: React.FC<TodayScreenProps> = () => {
  ...
  const expenses = todayRecord?.expenses || [];
    ...
    <div className="flex flex-col gap-4 pb-28 pt-2 relative">
      ...
      <div className="flex justify-between items-end px-1">
        <div className="flex flex-col">
          ...
          <span className="text-sm font-semibold text-[var(--color-text-body)]">05.08 – 04.09</span>
        </div>
      ...
      >
        <div>
          ...
          <p className="text-[11px] text-[var(--color-text-muted)]">к концу расчетного месяца (04.09)</p>
        </div>
        <div className="flex items-center gap-1.5">
        ...
        <div className="flex justify-between items-center">
          ...
          {!isAddingInline && (
            <button
              ...
              className="text-xs font-bold text-[var(--color-accent-badge-text)] hover:opacity-90 bg-[var(--color-accent-badge-bg)] border border-[var(--color-accent-badge-border)] px-2.5 py-1 rounded-xl flex items-center gap-1 transition-all"
            >
            ...
            >
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    type="submit"
                    className="px-4 py-1.5 bg-[#006d37] dark:bg-[#10b981] dark:text-[#041627] hover:bg-[#005228] dark:hover:bg-[#059669] text-white text-xs font-bold rounded-xl shadow-xs active:scale-95 transition-all flex items-center gap-1"
                  >
